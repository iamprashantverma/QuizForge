...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponseDTO> login(@Valid LoginRequestDTO loginDTO){
    ...
    @PostMapping("/signup")
    public ResponseEntity<UserResponseDTO> singUp(@Valid UserCreateDTO userCreateDTO) {
